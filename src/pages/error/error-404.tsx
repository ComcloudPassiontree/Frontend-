...
function Error404() {
    return (
        <div className="fade-in">
            <Header />
            <SecondaryHeader />
            <div className="flex items-center justify-center flex-col mt-[50px] gap-5 w-[96%] max-w-[600px] mx-auto fade-in-up">
                <img src={Image404} alt="Error 404" className="h-[310px]"/>
