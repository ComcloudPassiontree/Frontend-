  ...
  return (
    <div className="fade-in">
      ...
      <div className="flex items-center justify-center flex-col mt-[50px] gap-5 w-[90%] max-w-[600px] mx-auto fade-in-up">
        ...
        <H1 bold className="-mt-8">
          Error
        </H1>
        <Paragraph1 className="text-center">
          Oops! The page you're looking for doesn't exist. This might be due to
          poor internet connection or server issues. Please try again later.
        </Paragraph1>
